...
\| [Vereinfachtes Chinesisch] (../../Ducky.BuffRegistration/README.md) | [Englisch] (../../en/Ducky.BuffRegistration/README_en.md) | [English] (../../de/Ducky.BuffRegistration/README_de.md) | [Français] (../../fr/Ducky.BuffRegistration/README_fr.md) | [Español] (README_es.md) | [Japanisch] (../../ja/Ducky.BuffRegistration/README_ja.md) | [한국어] (../../ko/Ducky.BuffRegistration/README_ko.md) | [Português] (../../pt-PT/Ducky.BuffRegistration/README_pt.md) | [Русский] (../../ru/Ducky.BuffRegistration/README_ru.md) | [Traditionelles Chinesisch] (../../zh-TW/Ducky.BuffRegistration/README_zh.md) |
...
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
    ...
    <ModName>Ente.BuffRegistro</ModName>
  </PropertyGroup>
</Project>
```
...
<ItemGroup>
  <PackageReference Include="Ducky.Sdk" Version="x.y.z">
    <PrivateAssets>Aufgaben</PrivateAssets>
    <IncludeAssets>Ejecución; Konstruktion; Nativo; archivos de contenido; Analizadores; buildtransitiv</IncludeAssets>
  </PackageReference>
</ItemGroup>
```
...
ModBehaviour de clase pública : ModBehaviourBase
{
    ...
    anulación protegida void ModEnabled()
    {
        ...
        {
            Liebhaber. SetDisplayName(LK. BENUTZEROBERFLÄCHE. DoNothingBuffName)
    ...
    private void SceneLoader_onAfterSceneInitialize(SceneLoadingContext obj)
    {
        if (obj.sceneName == GameplayDataSettings.SceneManagement.BaseScene.Name)
        {
            ...
            if (main != null)
            {
                ...
                Haupt. AddBuff(Contract.Buffs.CreateBuffInstance(_buffId));
            }
        }
    }
}
...
- O edite 'assets/localmente/ directamente localmente' localmente localmente{lang}.csv' y vuelva a compilar para permitir que el SDK integre los cambios.
