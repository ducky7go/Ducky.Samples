...
\| [Vereinfachtes Chinesisch] (../../Ducky.PackageFromNuget/README.md) | [Englisch] (../../en/Ducky.PackageFromNuget/README_en.md) | [English] (../../de/Ducky.PackageFromNuget/README_de.md) | [Français] (../../fr/Ducky.PackageFromNuget/README_fr.md) | [Español] (../../es-ES/Ducky.PackageFromNuget/README_es.md) | [Japanisch] (../../ja/Ducky.PackageFromNuget/README_ja.md) | [한국어] (README_ko.md) | [Português] (../../pt-PT/Ducky.PackageFromNuget/README_pt.md) | [Русский] (../../ru/Ducky.PackageFromNuget/README_ru.md) | [Traditionelles Chinesisch] (../../zh-TW/Ducky.PackageFromNuget/README_zh.md) |
...
niceHeader 를 사용합니다.
  title: "멋진 YAML 구성"
  Beschreibung: "모드의 자산 폴더에서 YAML을 로드하는 데모입니다."
```
...
공개 클래스 ModBehaviour : ModBehaviourBase
{
    protected 재정의 void ModEnabled()
    {
        ...
        var dir = Pfad.GetDirectoryName(typeof(ModBehaviour)입니다. Montage.Ort)!;
...
```csharp
방법 1：조립 위치별(권장)
var modDir = Pfad.GetDirectoryName(typeof(ModBehaviour)입니다. Montage.Ort)!;
```
