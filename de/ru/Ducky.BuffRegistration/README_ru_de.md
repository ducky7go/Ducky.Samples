    ...
    защищенное переопределение void ModEnabled()
    {
        _buffId = Vertrag.Buffs.RegisterBuff<DoNothingBuff>(бафф =>
        {
            полировать. SetDisplayName(ЛК. Пользовательского интерфейса. DoNothingBuffName)
                . SetDescription(LK. Пользовательского интерфейса. DoNothingBuffBeschreibung)
...
- «ЛК. Пользовательского интерфейса. DoNothingBuffBeschreibung'
