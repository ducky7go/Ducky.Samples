...
"README.md
└── Vermögenswerte/ # Каталог файлов ресурсов
    «info.ini
    ├── description.md
    «lkeys.json
    «keys.hash.txt
...
публичный класс ModBehaviour : MyModBase
{
    защищенное переопределение void ModEnabled()
    {
        ...
        var Nachricht = LK. Пользовательского интерфейса. NiceWelcomeMessage;
...
О: Он будет генерировать '<AssetsDir>', т.е. файл 'lkeys.json' в директории 'Vermögenswerte/' основного проекта.
