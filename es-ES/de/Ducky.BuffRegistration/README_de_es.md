...
\| [Chino simplificado] (../../Ducky.BuffRegistration/README.md) | [Inglés] (../../en/Ducky.BuffRegistration/README_en.md) | [Deutsch] (README_de.md) | [Français] (../../fr/Ducky.BuffRegistration/README_fr.md) | [English] (../../es-ES/Ducky.BuffRegistration/README_es.md) | [Japonés] (../../ja/Ducky.BuffRegistration/README_ja.md) | [한국어] (../../ko/Ducky.BuffRegistration/README_ko.md) | [Português] (../../pt-PT/Ducky.BuffRegistration/README_pt.md) | [Русский] (../../ru/Ducky.BuffRegistration/README_ru.md) | [Chino tradicional] (../../zh-TW/Ducky.BuffRegistration/README_zh.md) |
...
In diesem Beispiel wird gezeigt, wie Sie Ducky.Sdk verwenden, mmm einen benutzerdefinierten Buff zu registrieren, einschließlich lokalisierter Schlüssel und Objektlayouts.Einstieg und Implementierung siehe ['Ducky.BuffRegistration/ModBehaviour.cs'](Ducky.BuffRegistration/ModBehaviour.cs:1)。
...
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
    ...
    <ImplicitUsings>ESTÍMULO</ImplicitUsings>
...
<ItemGroup>
  <PackageReference Include="Ducky.Sdk" Version="x.y.z">
    ...
    <IncludeAssets>Laufzeit; bauen; Ursprünglich; content-Dateien; Analizadores; buildtransitiv</IncludeAssets>
  </PackageReference>
</ItemGroup>
```
...
Verwenden Sie Contract.Buffs.RegisterBuff, mmm den Buff zu registrieren und den Anzeigenamen, die Beschreibung, das Symbol und die Lebensdauer im Rückruf festzulegen. Beispiel：
...
öffentliche Klasse ModBehaviour : ModBehaviourBase
{
    ...
    geschützte Überschreibung void ModEnabled()
    {
        ...
        {
            Abanicar. SetDisplayName(LK. BENUTZEROBERFLÄCHE. DoNothingBuffName)
...
6. Habilitar mod (inicio de Spiel)

Der Build stellt die Mod automatisch im Spielkatalog bereit, aktiviert die Mod in der Mod-Verwaltungsoberfläche des Spiels und startet das Spiel, mmm die Basisszene zu betreten und zu sehen, ob der Protagonist einen benutzerdefinierten Buff erhalten hat.
