...
Cet exemple montre comment développer des mods à l'aide d'un modèle d'architecture multicouche pour séparer le code partagé en projets de bibliothèque distincts pour la réutilisation du code et La concepción modula. Convient aux mods volumineux ou aux scénarios où le code doit être partagé entre plusieurs mods.
...
- **Proyecto de bibliothèque publique** ['Ducky.EntranceMod.Common/'](Ducky.EntranceMod.Common/) - Base de code partagée
...
Ducky.EntranceMod.Common/ # Proyecto de bibliothèque publique
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="Ducky.Sdk" Version="x.y.z">
      <PrivateAssets>presumir</PrivateAssets>
      <IncludeAssets>Duree; construire; indígena; archivos de contenido ; Analizadores; construiretransitivo</IncludeAssets>
    </PackageReference>
  </ItemGroup>
...
**Descripción de la configuración de base：**
...
### P : Pourquoi définir '<ExcludeSdkLib>Vrai</ExcludeSdkLib>\\`？
...
### P : Plusieurs projets de mods principaux peuvent-ils partager la même bibliothèque publique ?
