...
공개 클래스 ModBehaviour : MyModBase
{
    protected 재정의 void ModEnabled()
    {
        Log.Info("모드 활성화됨");
        공유 현지화 키 사용
        var mensaje = LK. UI. NiceWelcomeMessage입니다.
...
### P: '을 설정하는 이유<ExcludeSdkLib>참</ExcludeSdkLib>\\`？
