...
- 문서 기반 번역：'assets/localities/{lang}/', CSV 중앙값은 파일 이름으로 참조됩니다(예:：'"ducky.singleproject.ui.longdescription.md"'。
