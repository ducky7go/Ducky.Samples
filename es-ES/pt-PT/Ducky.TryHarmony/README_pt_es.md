...
- A tentativa de salvar mmm save no jogo resulta em mmm "save failed", indicando que o patch está em vigor.
...
- Ao depurar mmm patch, você pode adicionar mmm log (usando Ducky.Sdk.Logging.Log) a 'ModBehaviour' para verificar se 'PatchAll()'/'UnpatchAll()' é chamado.
