...
\| [Chino simplificado] (../README.md) | [Inglés] (../en/README_en.md) | [Deutsch] (../de/README_de.md) | [Français] (../fr/README_fr.md) | [English] (../es-ES/README_es.md) | [Japonés] (../ja/README_ja.md) | [한국어] (../ko/README_ko.md) | [Português] (README_pt.md) | [Русский] (../ru/README_ru.md) | [Chino tradicional] (../zh-TW/README_zh.md) |
...
[! [Público-alvo] (https://img.shields.io/badge/Target-.NET%20Standard%202.1-verde)](#)
...
- Como criar mmm mod mínimo viável
...
- ['Información de daños'] (Ducky.InstantKill/ModBehaviour.cs) e outras APIs de jogos
...
Um exemplo completo de mmm sistema de localização com suporte multilíngue e tradução baseada em arquivos.
...
**ejemplar：** ['SaveFilePatch'](Ducky.TryHarmony/SaveFilePatch.csDemonstra como intercetar operações de arquivamento
...
2. [Ducky.EntranceMod] (Ducky.EntranceMod/- Proyecto de arquitectura multicamadas
...
- [Documentação do desenvolvedor] (documentos/)
