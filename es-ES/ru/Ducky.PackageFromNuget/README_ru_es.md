...
ModBehaviour : ModBehaviourBase
{
    защищенное переопределение void ModEnabled()
    {
        ...
        if (File.Exists(ymlPath))
        {
            ...
            var niceData = deserializador. Десериализация<NiceData>(ymlContent);
...
Comprar NiceData
{
    ...
    публичный класс NiceDateHeader
    {
        ...
        public string Descripción { get; набор; } = строка. Пустой;
    }
}
```
