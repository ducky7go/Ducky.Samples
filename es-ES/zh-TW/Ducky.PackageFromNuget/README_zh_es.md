...
En este ejemplo se muestra cómo usar paquetes NuGet de terceros en Mod (con YamlDotNet como ejemplo), incluida la administración de dependencias, el acceso a archivos de recursos y la implementación de empaquetado de dependencias.
...
- ✅ Acceder al archivo de recursos del mod
- ✅ Controlar automáticamente el empaquetado de dependencias

**Escenarios de muestra：** Use la biblioteca YamlDotNet para leer y resolver perfiles YAML en la carpeta de recursos de Mod.
...
- La biblioteca de terceros (YamlDotNet) se empaquetará automáticamente en el directorio de salida de Mod
...
## 6. Acceso al archivo de recursos

### Obtén el catálogo de mods

```csharp
Método 1：Pase la ubicación de ensamblaje (recomendado)
...
1. Inicia el juego
2. Ingrese a la interfaz de administración de mods
3. Busque "Ducky.PackageFromNuget"
4. Haga clic en Habilitar
5. Mirando los registros del juego, deberías poder ver el contenido de YAML analizado
...
- [Ducky.SingleProject] (.. /Ducky.SingleProject/README.md): la estructura subyacente del proyecto
...
- ✅ Utilice una solución madura y estable
...
- ⚠️ Cumplir con las licencias de bibliotecas de terceros
