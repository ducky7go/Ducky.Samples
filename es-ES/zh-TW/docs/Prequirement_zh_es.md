...
- Herramientas globales necesarias：
  - Se usa para ejecutar dinámicamente documentos de C#：'dotnet-script'
  - Se utiliza para colecciones de programas y/o empaquetado：'dotnet-ilrepack'

## Requisitos del sistema

- Sistemas operativos compatibles：Linux / macOS / Windows (utilice la administración de paquetes de distribución o el script de instalación oficial para instalar el SDK de .NET)
- Espacio en disco y memoria recomendados：Al menos 2 GB de disco libre y 4 GB de memoria
...
El resultado debe incluir una versión del SDK que comience con "10.", como 10.0.x.

## Herramientas globales (obligatorio)

- Ejecutar dinámicamente scripts de C# (REPL/Compilación documentada/Widgets)

```bash
dotnet tool install -g dotnet-script
```

- Colección de programas y/paquete (se usa para generar un solo ensamblado o combinar dependencias de terceros)
