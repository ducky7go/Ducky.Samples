...
\| [Chinois simplifié] (../../Ducky.PackageFromNuget/README.md) | [Traduction] (../../en/Ducky.PackageFromNuget/README_en.md) | [Deutsch] (README_de.md) | [English] (../../fr/Ducky.PackageFromNuget/README_fr.md) | [Español] (../../es-ES/Ducky.PackageFromNuget/README_es.md) | [Japonais] (../../ja/Ducky.PackageFromNuget/README_ja.md) | [한국어] (../../ko/Ducky.PackageFromNuget/README_ko.md) | [Português] (../../pt-PT/Ducky.PackageFromNuget/README_pt.md) | [Русский] (../../ru/Ducky.PackageFromNuget/README_ru.md) | [Chinois traditionnel] (../../zh-TW/Ducky.PackageFromNuget/README_zh.md) |
...
"2�── ModBehaviour.cs # Mod-Einstiegsklasse
« README.md
└── Vermögenswerte/
    ├── info.ini # Meta-Informationen für Mods
    « Vorschaubild » preview.png # Vorschaubild
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    ...
    <PackageReference Include="Ducky.Sdk" Version="x.y.z">
      ...
      <IncludeAssets>Laufzeit ; Bauen ; ursprünglich ; content-Dateien ; Analysateurs ; BuildTransitIV</IncludeAssets>
    </PackageReference>
...
### Méthode 1：Verwenden der CLI (empfohlen)
...
### Méthode 2：Manuelles Bearbeiten von .csproj

Dans '<ItemGroup>" hinzugefügt：

```xml
<PackageReference Include="YamlDotNet" Version="16.3.0" />
```

### Méthode 3：Verwenden von Visual Studio
...
öffentliche Klasse ModBehaviour : ModBehaviourBase
{
    geschützte Überschreibung void ModEnabled()
    {
        ...
        var ymlPath = Pfad.Kombinieren(Réal, « nice.yml ») ;
...
öffentliche Klasse NiceData
{
    ...
    {
        public string Titel { get ; Garnitur ; } = Zeichenfolge. Lorgner;
        public string Beschreibung { get ; Garnitur ; } = Zeichenfolge. Lorgner;
    }
}
```
...
```csharp
Méthode 1：Nach Montageort (empfohlen)
