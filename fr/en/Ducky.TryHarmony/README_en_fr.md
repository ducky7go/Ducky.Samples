...
Ce répertoire ('Ducky.TryHarmony/') illustre le mode de patch Harmony：Enregistrez le correctif en appelant PatchAll d’Harmony dans ModEnabled, et annulez le correctif dans ModDisabled.Rendez-vous dans les réalisations clés：
