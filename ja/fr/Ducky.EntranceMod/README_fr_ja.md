...
\| [中国語(簡体字)](../../Ducky.EntranceMod/README.md) | [日本語](../../en/Ducky.EntranceMod/README_en.md) | [ドイツ語](../../de/Ducky.EntranceMod/README_de.md) | [フランセ](README_fr.md) | [スペイン語](../../es-ES/Ducky.EntranceMod/README_es.md) | [日本語](../../ja/Ducky.EntranceMod/README_ja.md) | [한국어](../../ko/Ducky.EntranceMod/README_ko.md) | [ポルトガル語](../../pt-PT/Ducky.EntranceMod/README_pt.md) | [Русский](../../ru/Ducky.EntranceMod/README_ru.md) | [繁体字中国語](../../zh-TW/Ducky.EntranceMod/README_zh.md) |
...
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
    ...
    <Nullable>アクティバー</Nullable>
    <LangVersion>アペルス</LangVersion>
  ...
  <ItemGroup>
    <PackageReference Include="Ducky.Sdk" Version="x.y.z">
      <PrivateAssets>ぽん引き</PrivateAssets>
      <IncludeAssets>デュリー; コンストラル; インディジェーヌ; コンテンツファイル ; 分析者; construire他動詞</IncludeAssets>
    </PackageReference>
  </ItemGroup>
...
## 6. Avantages de l'architecture マルチカーシュ
...
Ducky.EntranceMod.Common/ # コードユニバース
...
R : おうい! C'est l'avantage des architectures multi-niveaux. Plusieurs mods peuvent faire référence au même projet de bibliothèque publique.
...
- [環境準備文書] (.. /docs/Prequirement.md) です。
