...
```csharp
Ducky.EntranceMod.Commonを更新します。
...
публичный класс ModBehaviour : MyModBase
{
    защищенное переопределение void ModEnabled()
    {
        ...
        var message = LK です。 Пользовательского интерфейса. ナイスウェルカムメッセージ;
