...
\| [Chinês simplificado] (../../Ducky.Localization/README.md) | [Português] (../../en/Ducky.Localization/README_en.md) | [Alemão] (README_de.md) | [Français] (../../fr/Ducky.Localization/README_fr.md) | [Español] (../../es-ES/Ducky.Localization/README_es.md) | [Japonês] (../../ja/Ducky.Localization/README_ja.md) | [한국어] (../../ko/Ducky.Localization/README_ko.md) | [Português] (../../pt-PT/Ducky.Localization/README_pt.md) | [Русский] (../../ru/Ducky.Localization/README_ru.md) | [Chinês tradicional] (../../zh-TW/Ducky.Localization/README_zh.md) |
...
- Em ['Ducky.Localization/LK.cs'](Ducky.Localization/LK.cs:1) unter Verwendung statischer konstanter Organisationsschlüssel (z. B.：UI-Klassifikation).
...
- Dokumentenbasierte Übersetzung：Abgelegt em 'assets/locales/{lang}/', CSV-Mediana wird durch den Dateinamen referenziert, z.B.：'"ducky.singleproject.ui.longdescription.md"。
...
```csharp
mit Ducky.Sdk.Localizações;
mensagem var = L.UI. NiceWelcomeMessage; Löst zur Laufzeit eine Übersetzung der aktuellen Sprache auf
```

Erstellen e Ausführen
