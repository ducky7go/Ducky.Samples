...
Este diretório ('Ducky.TryHarmony/') demonstra o modo de patch Harmony：Registre o patch chamando PatchAll do Harmony em ModEnabled, e cancele o patch em ModDisabled.See you in key realizations：
