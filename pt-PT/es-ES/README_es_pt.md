...
\| [Chinês simplificado] (../README.md) | [Português] (../en/README_en.md) | [Alemão] (../de/README_de.md) | [Français] (../fr/README_fr.md) | [Español] (README_es.md) | [Japonês] (../ja/README_ja.md) | [한국어] (../ko/README_ko.md) | [Português] (../pt-PT/README_pt.md) | [Русский] (../ru/README_ru.md) | [Chinês tradicional] (../zh-TW/README_zh.md) |
...
[! [Plataforma] (https://img.shields.io/badge/Platform-Windows%20%7C%20LiNux%20%7C%20macOS-azul)](#)
[! [Idioma] (https://img.shields.io/badge/Language-C%23-239120?logo=csharp)](https://docs.microsoft.com/en-us/dotnet/csharp/)
[! [Objetivo] (https://img.shields.io/badge/Target-.NET%20STandard%202.1-verde)](#)
...
Este repositório contém vários projetos de realidade para demostrar o desenvolvimento do mod "Escape from Duckov", usando [Ducky.Sdk](https://www.nuget.org/packages/Ducky.Sdk).
...
- Sistemas operativos compatíveis：Windows / Linux / macOS

## 🎯 Comience rápidamente

```bash
# Clonar el repositório
git clonar <repository-url>
Muestras de cd |
...
Este repositório organiza los ejemplos en orden de fácil a difícil, y se recomienda estudiar en el siguiente orden：
...
- Cómo crear un mod mínimo viável
- ['ModBehaviour'] (Ducky.SingleProject/ModBehaviour.cs)
- A configuração básica do archivo '.csproj'

**Apto para personas：** Desarrolladores novos en el SDK de Ducky
...
- ✅ Arquivo de traducción CSV
- ✅ Traducción de documentos (Markdown)
- ✅ Soporte multilingüe (chino simplificado e inglês)

Puntos clave para aprender：\*\*

- Cómo organizar las claves de localización
- Uso de las funciones '[LanguageSupport]' y '[TranslateFile]'
- SDK generado automaticamentemente 'lkeys.json' y 'keys.hash.txt'
- Acesso à cidadania a cadenas de traducción
...
- ✅ Criação e adición de instancias de buff
...
#### [Ducky.PackageFromNuget] (Ducky.PackageFromNuget/- Agência de dependências de terceros
...
- Mecanismo de manejo de dependências del SDK
...
#### [Ducky.EntranceMod] (Ducky.EntranceMod/) + [Ducky.EntranceMod.Common](Ducky.EntranceMod.Common/- Arquitetura de vários níveis

**dificultado：⭐⭐⭐⭐**

Muestra cómo dividir mods en arquiteturas multicapa para la reutilización de código.
...
- Cómo crear una biblioteca de mods reutilizável
- Uso compartido entre proyectos de archivos de recursos
- Diseño de arquitetura para grandes mods
...
**EJEMPLO：** ['SaveFilePatch'](Ducky.TryHarmony/SaveFilePatch.csMuestra cómo intercetar operaciones de archivo

**Apto para personas：** Desarrolladores avançados que necesitan modificar profundamente la lógica del juego

⚠️ **Nota.：** Los parches de Harmony son potentes, pero deben usarse con precaución, y los parches incorretos pueden hacer que el juego se bloquee

👉 [Ver tutorial detallado](Ducky.TryHarmony/README.md)

---

## 🏗️ Arquitetura del proyecto

Todos los proyectos de muestra siguen las siguientes convenciones básicas：

### Configuración del proyecto (obrigatório)
...
2. [Ducky.EntranceMod] (Ducky.EntranceMod/- Diseño de arquitetura multicapa
3. [Ducky.TryHarmony] (Ducky.TryHarmony/- Inyección de código en tiempo de ejecución

## 🛠️ Compilação e implementação
...
- **Geração automática**：Los metadatos localizados se generan automáticamente en tiempo de compilación
