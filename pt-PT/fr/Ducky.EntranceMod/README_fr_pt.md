...
\| [Chinês simplificado] (../../Ducky.EntranceMod/README.md) | [Português] (../../en/Ducky.EntranceMod/README_en.md) | [Alemão] (../../de/Ducky.EntranceMod/README_de.md) | [Français] (README_fr.md) | [Español] (../../es-ES/Ducky.EntranceMod/README_es.md) | [Japonês] (../../ja/Ducky.EntranceMod/README_ja.md) | [한국어] (../../ko/Ducky.EntranceMod/README_ko.md) | [Português] (../../pt-PT/Ducky.EntranceMod/README_pt.md) | [Русский] (../../ru/Ducky.EntranceMod/README_ru.md) | [Chinês tradicional] (../../zh-TW/Ducky.EntranceMod/README_zh.md) |
...
Cet exemple montre comment développer des mods à l'aide d'un modèle d'architecture multicouche pour séparer le code partagé en projets de bibliothèque distincts pour la réutilisation du code et la conceção modulaire. Convient aux mods volumineux ou aux scénarios où le code doit être partagé entre plusieurs mods.
...
- **Projet principal de mods** ['Ducky.EntranceMod/'](Ducky.EntranceMod/) - Entrada do mod contenant des fichiers de ressources
- **Projeto de bibliothèque publique** ['Ducky.EntranceMod.Common/'](Ducky.EntranceMod.Common/) - Base de code partagée
...
Configuração du projet Ducky.EntranceMod.csproj #
...
Ducky.EntranceMod.Common/ # Projeto de bibliothèque publique
...
## 3. Configuração do projeto de mod principal
...
### Partager les clés de localização
...
```csharp
pt utilisant Ducky.Sdk.ModBehaviours ;
...
classe abstraite publique MyModBase : ModBehaviourBase
{
    ...
    vazio virtual protegido LogModInfo(message de chaîne)
    {
...
- Les bibliothèques SDK ne sont pas incluses de manière répétée (carro »<ExcludeSdkLib>Vrai</ExcludeSdkLib>\\`）
...
Ducky.EntranceMod.Common/ # Código universel
