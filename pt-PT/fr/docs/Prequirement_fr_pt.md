...
Après l'installation, ajoutez le chemin d'accès du SDK au PATH ou exécutez-le avec le chemin d'accès complet dans le terminal. Vérifiez l'instalação：
