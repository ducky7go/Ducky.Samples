...
\| [Chinês simplificado] (../../Ducky.EntranceMod/README.md) | [Português] (../../en/Ducky.EntranceMod/README_en.md) | [Alemão] (../../de/Ducky.EntranceMod/README_de.md) | [Français] (../../fr/Ducky.EntranceMod/README_fr.md) | [Español] (../../es-ES/Ducky.EntranceMod/README_es.md) | [Japonês] (../../ja/Ducky.EntranceMod/README_ja.md) | [한국어] (README_ko.md) | [Português] (../../pt-PT/Ducky.EntranceMod/README_pt.md) | [Русский] (../../ru/Ducky.EntranceMod/README_ru.md) | [Chinês tradicional] (../../zh-TW/Ducky.EntranceMod/README_zh.md) |
...
- **메인 모드 프로젝트** ['Ducky.EntranceMod/'](Ducky.EntranceMod/) - 리소스 파일이 포함된 모드 입구
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="Ducky.Sdk" Version="x.y.z">
      ...
      <IncludeAssets>런타임; 체격; 원주민; conteúdo파일; 분석기; 빌드전이적</IncludeAssets>
    </PackageReference>
  </ItemGroup>
...
- \\`<ExcludeSdkLib>참</ExcludeSdkLib>- SDK 라이브러리를 출력 디렉터리에 중복 패키징하지 않도록 합니다.
...
{
    protegido 재정의 void ModEnabled()
    {
        Log.Info("모드 활성화됨");
        공유 현지화 키 사용
        var mensagem = LK. UI. NiceWelcomeMessage입니다.
        LogModInfo($"환영 메시지 키: {message}");
    }

    protegido 재정의 void ModDisabled()
    {
        Log.Info("모드 비활성화됨");
    }
}
...
R: Ducky.Sdk의 라이브러리 파일을 모드 출력 디렉토리에 중복 패키징하지 마십시오. SDK 라이브러리는 이미 게임에 존재하므로 다시 포함할 필요가 없습니다.

### Q: \\`<AssetsDir>설정해야 합니까?

A: 공용 도서관 프로젝트의 경우 현지화 키(LK.cs)를 포함하는 경우 '<AssetsDir>SDK가 지역화된 메타데이터를 제대로 생성할 수 있도록 기본 프로젝트의 자산 디렉터리를 가리킵니다.
...
R: '로 생성됩니다.<AssetsDir>' 지정된 디렉토리, 즉 메인 프로젝트의 'assets/' 디렉토리 아래에 있는 'lkeys.json' 파일입니다.
...
모드가 비교적 간단하다면 [Ducky.SingleProject](../Ducky.SingleProject/README.md) 단일 프로젝트 모델.
