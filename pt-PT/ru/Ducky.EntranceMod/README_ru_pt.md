...
├── README.md
└── ativos/ # Каталог файлов ресурсов
    «info.ini
    ├── description.md
    «lkeys.json
    «keys.hash.txt
...
публичный класс ModBehaviour : MyModBase
{
    защищенное переопределение void ModEnabled()
    {
        ...
        var mensagem = LK. Пользовательского интерфейса. NiceWelcomeMessage;
