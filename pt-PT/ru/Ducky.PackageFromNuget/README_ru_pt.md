...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    ...
    <PackageReference Include="Ducky.Sdk" Version="x.y.z">
      ...
      <IncludeAssets>Среды выполнения; строить; родной; файлы содержимого; Анализаторы; construirtransitivo</IncludeAssets>
    </PackageReference>
...
niceHeader:
  ...
  descrição: "Это демонстрация загрузки YAML из папки assets мода"
```
...
публичный класс ModBehaviour : ModBehaviourBase
{
    защищенное переопределение void ModEnabled()
    {
        ...
        if (File.Exists(ymlPath))
        {
            ...
            var niceData = desserializador. Десериализация<NiceData>(ymlContent);
...
```csharp
ativos/ будет скопирован в корневой каталог выходного каталога Mod
