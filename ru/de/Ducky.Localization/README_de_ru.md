...
\| [Китайский упрощенный] (../../Ducky.Localization/README.md) | [Английский] (../../en/Ducky.Localization/README_en.md) | [Дойч] (README_de.md) | [Франсе] (../../fr/Ducky.Localization/README_fr.md) | [Эспаньол] (../../es-ES/Ducky.Localization/README_es.md) | [Японский] (../../ja/Ducky.Localization/README_ja.md) | [한국어] (../../ko/Ducky.Localization/README_ko.md) | [Португес] (../../pt-PT/Ducky.Localization/README_pt.md) | [Русский] (../../ru/Ducky.Localization/README_ru.md) | [Традиционный китайский] (../../zh-TW/Ducky.Localization/README_zh.md) |

<!-- LANG_HEADER_END -->

# Ducky.Локализация Beispiel-Mod
...
- ['Ducky.Локализация/ModBehaviour.cs'] (Ducky.Localization/ModBehaviour.cs:1) — Mod-Eintrag, der zeigt, wie lokalisierte Zeichenketten referenziert werden.
- ['Ducky.Локализация/LK.cs'] (Ducky.Localization/LK.cs:1) — Statische, lokalisierte Schlüsseldefinitionen (es wird empfohlen, sie im Code zu verwalten).
...
- В ['Ducky.Localization/LK.cs'](Ducky.Localization/LK.cs:1) unter Verwendung statischer konstanter Organisationsschlüssel (z. B.：UI-Klassifikation).
