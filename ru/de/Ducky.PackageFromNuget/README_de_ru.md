...
\| [Китайский упрощенный] (../../Ducky.PackageFromNuget/README.md) | [Английский] (../../en/Ducky.PackageFromNuget/README_en.md) | [Дойч] (README_de.md) | [Франсе] (../../fr/Ducky.PackageFromNuget/README_fr.md) | [Эспаньол] (../../es-ES/Ducky.PackageFromNuget/README_es.md) | [Японский] (../../ja/Ducky.PackageFromNuget/README_ja.md) | [한국어] (../../ko/Ducky.PackageFromNuget/README_ko.md) | [Португес] (../../pt-PT/Ducky.PackageFromNuget/README_pt.md) | [Русский] (../../ru/Ducky.PackageFromNuget/README_ru.md) | [Традиционный китайский] (../../zh-TW/Ducky.PackageFromNuget/README_zh.md) |
...
### Метод 1：Verwenden der CLI (empfohlen)
...
### Метод 2：Manuelles Bearbeiten von .csproj

В «<ItemGroup>" hinzugefügt：

```xml
<PackageReference Include="YamlDotNet" Version="16.3.0" />
```

### Метод 3：Verwenden von Visual Studio
...
```yaml
niceHeader:
  название: "Schöne YAML-Konfiguration"
...
{
    public NiceDateHeader NiceHeader { get; Гарнитур; } = neu();

    öffentliche Klasse NiceDateHeader
    {
        публичная строка Titel { get; Гарнитур; } = Zeichenfolge. Смотреть искоса;
        public string Beschreibung { get; Гарнитур; } = Zeichenfolge. Смотреть искоса;
    }
}
```
...
```csharp
Метод 1：Nach Montageort (empfohlen)
