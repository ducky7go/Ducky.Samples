...
\| [Китайский упрощенный] (../../Ducky.EntranceMod/README.md) | [Английский] (../../en/Ducky.EntranceMod/README_en.md) | [Дойч] (../../de/Ducky.EntranceMod/README_de.md) | [Франсе] (README_fr.md) | [Эспаньол] (../../es-ES/Ducky.EntranceMod/README_es.md) | [Японский] (../../ja/Ducky.EntranceMod/README_ja.md) | [한국어] (../../ko/Ducky.EntranceMod/README_ko.md) | [Португес] (../../pt-PT/Ducky.EntranceMod/README_pt.md) | [Русский] (../../ru/Ducky.EntranceMod/README_ru.md) | [Традиционный китайский] (../../zh-TW/Ducky.EntranceMod/README_zh.md) |
...
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
    ...
    <Nullable>Активатор</Nullable>
    <LangVersion>Аперсу</LangVersion>
    <ImplicitUsings>Врай</ImplicitUsings>
    <ModName>Ducky.EntranceMod</ModName>
    <!-- 关键：排除 SDK 库，避免重复打包 -->
    <ExcludeSdkLib>Врай</ExcludeSdkLib>
  </PropertyGroup>

  <ItemGroup>
    <PackageReference Include="Ducky.Sdk" Version="x.y.z">
      <PrivateAssets>коммивояжер</PrivateAssets>
      <IncludeAssets>Дьюри; construire; Индейский; файлы содержимого; Анализаторы; Construiretransitive</IncludeAssets>
    </PackageReference>
  </ItemGroup>
...
- \\`<ExcludeSdkLib>Врай</ExcludeSdkLib>- Éviter l'empaquetage en double des bibliothèques SDK dans le répertoire de sortie
...
- \\`<IsModLib>Врай</IsModLib>' - Marquez cet élément comme une bibliothèque de mods, le SDK le gérera spécialement
...
- Les bibliothèques SDK ne sont pas incluses de manière répétée (car '<ExcludeSdkLib>Врай</ExcludeSdkLib>\\`）
...
```
Ducky.EntranceMod/ # Мод Мэтр
Ducky.EntranceMod.Common/ # Код universel
Ducky.EntranceMod.Геймплей/ # Logique de jeu
Ducky.EntranceMod.UI/ # Lié à l'interface utilisateur
```

## 10. Foire aux questions

### Q : Pourquoi définir '<ExcludeSdkLib>Врай</ExcludeSdkLib>\\`？
...
- [Ducky.Локализация] (.. /Ducky.Localization/README.md- Explication détaillée du système de localisation
