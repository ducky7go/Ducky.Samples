...
\| [Китайский упрощенный] (../../docs/Prequirement.md) | [Английский] (../../en/docs/Prequirement_en.md) | [Дойч] (../../de/docs/Prequirement_de.md) | [Франсе] (../../fr/docs/Prequirement_fr.md) | [Эспаньол] (../../es-ES/docs/Prequirement_es.md) | [Японский] (../../ja/docs/Prequirement_ja.md) | [한국어] (../../ko/docs/Prequirement_ko.md) | [Португес] (../../pt-PT/docs/Prequirement_pt.md) | [Русский] (../../ru/docs/Prequirement_ru.md) | [Традиционный китайский] (Prequirement_zh.md) |
...
- Необходимые глобальные инструменты：
  - Используется для динамического выполнения документов C#：'dotnet-script'
  - Используется для коллекций программ и/или упаковки：'dotnet-ilrepack'

## Требования к системе

- Поддерживаемые операционные системы：Linux / macOS / Windows (пожалуйста, используйте управление дистрибутивом или официальный скрипт установки для установки .NET SDK)
- Рекомендуемое дисковое пространство и память：Не менее 2 ГБ свободного места на диске и 4 ГБ памяти
...
Выходные данные должны включать версию SDK, которая начинается с "10.", например 10.0.x.

## Глобальные инструменты (обязательно)

- Динамическое выполнение скриптов C# (REPL/документированная сборка/виджеты)

```bash
dotnet tool install -g dotnet-script
```

- Программный сбор и/или пакет (используется для создания одной сборки или слияния сторонних зависимостей)
