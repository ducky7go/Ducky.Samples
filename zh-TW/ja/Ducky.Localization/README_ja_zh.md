...
\| [簡體中文](../../Ducky.Localization/README.md) | [English](../../en/Ducky.Localization/README_en.md) | [Deutsch](../../de/Ducky.Localization/README_de.md) | [Français](../../fr/Ducky.Localization/README_fr.md) | [Español](../../es-ES/Ducky.Localization/README_es.md) | [日本語](README_ja.md) | [한국어](../../ko/Ducky.Localization/README_ko.md) | [Português](../../pt-PT/Ducky.Localization/README_pt.md) | [Русский](../../ru/Ducky.Localization/README_ru.md) | [繁體中文](../../zh-TW/Ducky.Localization/README_zh.md) |
...
- ['Ducky.Localization/assets/'](Ducky.Localization/assets/:1） — 翻訳 CSV、ドキュメントベースの翻訳、説明 などのリソースが含まれます。
...
- サポートされている言語を宣言するは、[LanguageSupport（“en”，“en”，“zh-hant”）]' 属性を使用します （必要な場合）。
...
- または、'assets/locales/を直接'編集します{lang}.csv」を呼び出し、SDK が変更を統合できる|うに再コンパイルします。
...
- 長いテキストは、ソースコードポジトリのメンテナンスを改善すナンンスを改善すを改善すを改善すのメンテテナンストリのメンテテナンために、ファイルベースの翻訳を使用することをお勧めします。
